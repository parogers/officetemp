(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.officetemp = f()}})(function(){var define,module,exports;return (function(){function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s}return e})()({1:[function(require,module,exports){
...
class DemoScreen {
   preload() {
      this.game.load.atlas('sprites', 'media/sprites.png', 'media/sprites.json?time=' + new Date().getTime());
...
function start() {
    var game = new Phaser.Game(500, 300, // canvas size
...
},{"./demo.js":1,"./title.js":4}],3:[function(require,module,exports){
/* officetemper - A game about temp work
 * Copyright (C) 2017  Peter Rogers
 *
 * This program is free software: you can redistribute it and/or modify
...
class TitleScreen {
			...
			create() {
						...
						this.timers = new Timer.TimerList();
						/*this.timers.create(() => {
          console.log("DONE");
      }, 5);*/
      ...
      console.log(sprite.frameName);*/
						...
						this.toplevel = this.game.add.sprite();
						this.toplevel.scale.set(2);

						this.terrance = this.toplevel.addChild(this.game.add.sprite(0, 0, 'sprites', 'terrance_frazzled'));
						...
						this.sweaterGuy = this.toplevel.addChild(this.game.add.sprite(0, 0, 'sprites'));
						this.sweaterGuy.anchor.set(0.5, 1);
						//this.sweaterGuy.scale.set(3);
						this.sweaterGuy.position.set(50, 100);

						let anim = this.sweaterGuy.animations.add("drink", ["sweater_drink1", "sweater_drink1", "sweater_drink2"], 1);
						anim.loop = true;
						anim.play();
			...
			update() {
						...
						let x = this.terranceX + 0.75 * Math.sin(50 * this.timeCount);
						let y = this.terranceY + 0.5 * Math.cos(40 * this.timeCount);
